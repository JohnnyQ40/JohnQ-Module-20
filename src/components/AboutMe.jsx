...
function AboutMe() {
    return (
        <section>
            ...
            As much as I may love the outdoors, I can always count on the fact that she will be that much more excited than I am to take a walk, or head down to the creek.</p>
        </section>
    );
}
